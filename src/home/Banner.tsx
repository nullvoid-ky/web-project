    ...
    <>
      <div className="flex flex-row w-full h-[calc(40dvh-48px)] sm:h-96 sm:mb-32 bg-[url('https://i.ebayimg.com/images/g/hrsAAOSwQhNlbipp/s-l1600.jpg')] bg-center bg-cover shadow-md shadow-midnight-900">
        ...
        <div className="absolute">
          ...
          <h5 className="flex text-xs sm:text-sm font-bold  text-pearl-700">
              Reccommend
            </h5>
            <h1 className="flex text-2xl sm:text-4xl font-bold mb-2 text-pearl-200">
              Im The Boss
            </h1>
            <button className="bigger flex max-w-64 bg-midnight-600 border-neutral-700 hover:border-neutral-600 border-[1px] w-24 sm:w-32 text-center items-center justify-center p-2 sm:p-4 text-pearl-400 rounded-lg hover:bg-midnight-400">
             เล่นเลย
            </button>
          </div>
        </div>
