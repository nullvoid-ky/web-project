...
const BoardgameContent: React.FC<BoardgameCardType> = ({ data }) => {
  return (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-y-2 sm:gap-y-8 sm:gap-8 w-full h-[calc(100%-132px)]">
        {data.map((game) => (
